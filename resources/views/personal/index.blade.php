            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="mimodalLabel">Ver Personal</h1>
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-6 mb-5">
                                    ...
                                    <input type="text" class="form-control" id="verdni" readonly>
                                </div>
                                <div class="col-sm-6 col-lg-6 mb-5">
                                ...
                                <div class="col-sm-6 col-lg-4 mb-5">
                                    ...
                                    <input type="text" class="form-control" id="verpuesto" readonly>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-5">
...
<script>
    ...
    mimodal.addEventListener('show.bs.modal', event => {
        ...
        var urlregistro = "{{ url('personal/show') }}";
    ...
    var personales = @json($personales);
    var urlPersonales = "{{ url('personal') }}";


    var table = defineTable($('#listado'), [], [0, 1, 2, 3, 4, 5,6], 'Personal', function() {}, true, true, false);

    $('#buscador').keyup(function(e) {
        table.search(e.target.value).draw();
    });
 
    listarOnTable(table, personales, 0, [], true, true, true, urlPersonales, false, []);
</script>
