                ...
                <Form method="POST" action="{{ url('usuario/store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-4 mb-5">
                            ...
                            <input type="password" placeholder=" Ingrese descripcion" name="password" id="password" class="form-control" required>
                        </div>
                        <div class="col-sm-12 col-lg-4 mb-5">
                            <label for="password" class="required form-label">Confirmar Contraseña </label> <span id="result"></span>
                            <input type="password" placeholder=" Ingrese descripcion" name="password1" id="password1" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <a href="{{url('usuario/index')}}" type="button" class="btn btn-light">
