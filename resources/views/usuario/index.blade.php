            ...
            <table id="listado" data-page-length='5' class="table table-row-bordered table-row-success table-rounded border gs-7 align-middle" style="width: 92,5vw;">
                <thead>
                    <tr class=" text-primary fw-bold fs-6" id="fila">
                        ...
                        <th class="w-80px">Contraseña</th>
                        <th class="w-80px">Rol</th>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="mimodalLabel">Ver Usuario</h1>
                        ...
                        <form>
                            <div class="row">
                               <div class="col-sm-6 col-lg-6 mb-5">
                                    ...
                                    <input type="text" class="form-control" id="vername" readonly>
                                </div>
                                ...
                                <div class="col-sm-12 col-lg-4 mb-5">
                                    ...
                                    <input type="text" class="form-control" id="verrol" readonly>
                                </div>
                                <div class="col-sm-12 col-lg-8 mb-5">
                                    <label for="password" class="col-form-label">Contraseña:</label>
                                    <input type="text" class="form-control" id="verpassword" readonly>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    mimodal.addEventListener('show.bs.modal', event => {
        ...
        var urlregistro = "{{ url('usuario/show') }}";
        $.get(urlregistro + '/' + id, function(data) {
             
            const modalTitle = mimodal.querySelector('.modal-title')
            modalTitle.textContent = `Ver Registro ${id}` 
            
            document.getElementById("verrol").value=data.rol;  
            document.getElementById("vername").value=data.name;  
            document.getElementById("verpassword").value=data.password;  
    ...
    var urlusuarios = "{{ url('usuario') }}";


    var table = defineTable($('#listado'), [], [0, 1, 2,3,4 ], 'usuarios', function() {}, true, true, false);
    ...
    listarOnTable(table, usuarios, 0, [], true, true, true, urlusuarios, false, []);
</script>
