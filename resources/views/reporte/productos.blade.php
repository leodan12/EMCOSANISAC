...
<br><br><br><br><br><br>  
<div class="row">
<div class="col-12"> <h4>Listado de Productos Mas Vendidos </h4></div>
...
<br>   
<div class="row">
<div class="col-12"> <h4>Listado de Productos Menos Vendidos </h4></div>
<div class="table-responsive">
            <div class="d-flex flex-stack">
                <div class="d-flex btn-excel-datatable"> </div> 
                <div class="d-flex justify-content-end">
...
<script>
    ...
    function llenarTabla(){
        ...
        var fechaF = document.getElementById('fechafinal').value;
         ...
         $.get('/productosenfecha/' + fechaI + '/' + fechaF, function(data) { 
        var ProductosTabla = data; 
        generarTabla(ProductosTabla); 
       }); 
       $.get('/productosenfecha2/' + fechaI + '/' + fechaF, function(data) { 
