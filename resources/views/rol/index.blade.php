...
<div class="">
    <div class="row">
        <div class="d-flex justify-content-end mb-5" data-kt-docs-table-toolbar="base">
            <a href="{{url('rol/create')}}" class="btn btn-primary">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="mimodalLabel">Ver Rol</h1>
...
<script>
    ...
    var urlroles = "{{ url('rol') }}";


    var table = defineTable($('#listado'), [], [0, 1, 2 ], 'roles', function() {}, true, true, false);
    ...
    listarOnTable(table, roles, 0, [], true, true, true, urlroles, false, []);
</script>
