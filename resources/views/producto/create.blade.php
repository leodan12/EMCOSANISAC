                ...
                <Form method="POST" action="{{ url('producto/store') }}">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4 mb-5">
                            ...
                            <input type="text" placeholder=" ingrese producto" name="producto" id="producto" class="form-control" required>
                        </div>
                        <div class="col-sm-6 col-lg-4 mb-5">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-5">
                            ...
                            <input type="number" step=0.1 placeholder=" Ingrese precio" name="precio" id="precio" class="form-control" required>
                        </div>
                        <div class="col-sm-6 col-lg-4 mb-5">
                            <label for="peso" class="required form-label">Peso</label>
                            <input type="number" step=0.01 placeholder=" Ingrese Peso" name="peso" id="peso" class="form-control" required>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 mb-5">
                            ...
                            <input type="text" placeholder=" ingrese codigo" name="codigo" id="codigo" class="form-control" required>
                        </div>
