...
<script>
    ...
    mimodal.addEventListener('show.bs.modal', event => {
        ...
        var urlregistro = "{{ url('proveedor/show') }}";
        $.get(urlregistro + '/' + id, function(data) {
            
            const modalTitle = mimodal.querySelector('.modal-title')
            modalTitle.textContent = `Ver Registro ${id}` 
            document.getElementById("verproveedor").value=data.proveedor;  
    ...
    var urlProveedores = "{{ url('proveedor') }}";


    var table = defineTable($('#listado'), [], [0, 1, 2, 3, 4, 5], 'Proveedores', function() {}, true, true, false);
    ...
    listarOnTable(table, proveedores, 0, [], viewbtn, editbtn, deletetn, urlProveedores, false, []);
</script>
